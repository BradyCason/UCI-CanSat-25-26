...
try:
    ...
    while True:
        ...
        if state_5 == GPIO.LOW :
            ...
            flash_led(pin_0)
            print("Pin 0 flashes status LED to show sending xbee packet")

        if state_13 == GPIO.LOW :
            print("Set UTC time button pressed")
            print("Pin 13 button pressed, do work...")
            flash_led(pin_6)
            print("Pin 6 flashes status LED to show sending xbee packet")
        ...
        if state_27 == GPIO.LOW :
            ...
            flash_led(pin_22)
            print("Pin 22 flashes status LED to show sending xbee packet")

        if state_4 == GPIO.LOW :
            print("Payload release button pressed")
            print("Pin 4 button pressed, do work...")
            flash_led(pin_17)
            print("Pin 17 flashes status LED to show sending xbee packet")
